...
import '../../data/interactors/auth/firebase_auth_interactor.dart' as _i21;
...
import '../../domain/entities/emotion/emotion_note.dart' as _i19;
import '../../domain/interactors/auth/auth_interactor.dart' as _i20;
...
import '../../ui/screens/home/home_store.dart' as _i22;
...
import '../modules/firebase_module.dart' as _i23;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i18.AddEmotionViewModel, _i19.EmotionNote?, dynamic>(
      (note, _) => _i18.AddEmotionStore(
          get<_i3.AppRouter>(), get<_i15.EmotionNotesInteractor>(), note));
  gh.factory<_i20.AuthInteractor>(() => _i21.DefaultAuthInteractor(
      get<_i13.AuthService>(), get<_i11.AuthManager>()));
  gh.factory<_i22.HomeViewModel>(
      () => _i22.HomeStore(get<_i20.AuthInteractor>(), get<_i3.AppRouter>()));
  return get;
}
